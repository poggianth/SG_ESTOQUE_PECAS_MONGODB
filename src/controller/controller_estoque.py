        ...
        if relatorio.get_estoque_todos_estoques():
            ...
            try:
                ...
                if self.existe_estoque(codigo_estoque_alterar):
                    ...
                    self.mongo.db[self.collection_name].update_one({"codigo": codigo_estoque_alterar}, {"$set": {"tipo": tipo_estoque_novo}})
                    ...
                    print(f"Não existe nenhum estoque com o código = {codigo_estoque_alterar}")
            ...
            try:
                ...
                if self.existe_estoque(codigo_estoque_excluir):
                    ...
                    if opcao_certeza == 1:
                        ...
                        self.mongo.db[self.collection_name].delete_one({"codigo": codigo_estoque_excluir})
                    ...
                    print(f"Não existe nenhum estoque com o código = {codigo_estoque_excluir}")
